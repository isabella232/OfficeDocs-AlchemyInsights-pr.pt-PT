...
1. Abra uma aplicação do Office e [termine sessão](https://support.office.com/article/5a20dc11-47e9-4b6f-945d-478cb6d92071) em quaisquer uma das contas de utilizador existentes.   
2. Utilizando **contas de definições do** Windows  >    >  **Enviar por email & contas,** remova as contas de trabalho existentes. 
3. Utilização de **Contas do** Windows Acesso ao trabalho ou  >    >  **à escola,** desligue as contas existentes. 
