...
4. Na caixa **Alias,** escreva um novo e-mail e, em seguida, escolha **Adicionar**. Se tiver comprado a sua subscrição na GoDaddy ou noutro parceiro, para definir o novo alias como o principal, tem de aceder à consola de gestão de parceiros/GoDaddy. 
    ...
    **Para mais detalhes, consulte este artigo:** [Adicione mais um pseudónimo de e-mail para um utilizador](https://docs.microsoft.com/microsoft-365/admin/email/add-another-email-alias-for-a-user)
