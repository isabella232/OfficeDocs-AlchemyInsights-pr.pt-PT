...
4. Seleccione a opção de **chave de produto de novo e não utilizada** . (Se esta subscrição foi criada com uma chave de produto adquirida numa localização de revenda, poderá ter a opção de adicionar os utilizadores com outros métodos de pagamento.) 
