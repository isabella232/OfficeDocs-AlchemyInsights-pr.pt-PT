...
---
# <a name="calendar-sharing-in-outlook"></a>Partilha de calendário no Outlook

Para obter informações sobre a partilha de um calendário do Outlook, consulte estes artigos:
