...
Os administradores podem cancelar a subscrição do Projeto para a sua organização a partir do centro de administração da **Microsoft 365**.

1. Vá à página de **Faturação > [Seus produtos.](https://go.microsoft.com/fwlink/p/?linkid=842054) **

2. Localize o Plano de Projeto para cancelar.
