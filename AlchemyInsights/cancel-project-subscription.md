...
ms.locfileid: "58330455"
---
# <a name="cancel-project-subscription"></a>Cancelar Project subscrição

Os administradores podem cancelar a Project subscrição de subscrição de empresa da respetiva organização no centro de administração do Microsoft 365.

1. Vá para a página **Faturação** \> [dos seus](https://go.microsoft.com/fwlink/p/?linkid=842054) produtos.
2. No **separador** Produtos, locale a Project subscrição que pretende cancelar. Selecione os três pontos (mais ações) e, em **seguida, selecione Cancelar subscrição**.
