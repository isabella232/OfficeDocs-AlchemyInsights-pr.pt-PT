...
- Se tiver menos de 25 licenças atribuídas, pode cancelar a subscrição online. Vá para a página de [subscrições](https://go.microsoft.com/fwlink/p/?linkid=842054) , ou vá para a **Facturação** \> de **subscrições**e, em seguida, escolha as **acções mais** \> **Cancelar a subscrição**.
...
- Para mais informações sobre como cancelar uma subscrição ou para obter instruções passo a passo, consulte [Cancelar Office 365 para a empresa](https://support.office.com/article/b1bc0bef-4608-4601-813a-cdd9f746709a).
