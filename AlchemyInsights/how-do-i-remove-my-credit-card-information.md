...
---
# <a name="how-do-i-remove-my-credit-card-information"></a>Como retiro a informação do meu cartão de crédito?
...
2. Na página **de métodos de pagamento,** escolha o cartão de crédito ou a conta bancária para apagar.

3. Para remover o cartão de crédito ou conta bancária, **selecione Eliminar o método de pagamento.**
...
4. No painel de **método de pagamento Eliminar,** selecione **Delete**.
