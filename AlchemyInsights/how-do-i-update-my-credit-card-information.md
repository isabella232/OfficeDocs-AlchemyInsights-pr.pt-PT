...
2. Selecione a linha do método de pagamento para atualizar. No painel direito, selecione **Editar**.
3. Atualize as informações de sua forma de pagamento, incluindo o nome no cartão de crédito ou débito, endereço de cobrança ou data de validade e selecione **Guardar**.
