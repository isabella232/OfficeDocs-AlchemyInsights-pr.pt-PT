...
ms.locfileid: "29484177"
---
# <a name="how-to-use-the-sharepoint-online-term-store"></a>Como utilizar o arquivo de termos Online do SharePoint

O arquivo de termos está disponível para uma Administração Global do Office 365, administração do SharePoint e Admins de arquivo de termos e podem ser encontrado no Centro de administração de SharePoint Online clássico. 
