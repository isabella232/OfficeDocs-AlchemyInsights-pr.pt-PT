...
A Microsoft retirou a oferta híbrida de serviço MDM a partir de 1 de setembro de 2019. Quaisquer dispositivos HÍBRIDOS restantes não receberão atualizações de política, apps ou segurança. Para mais informações, [reveja o que aconteceu ao MDM híbrido?](https://docs.microsoft.com/configmgr/mdm/understand/what-happened-to-hybrid)