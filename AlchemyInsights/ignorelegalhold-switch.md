...
O **– IgnoreLegalhold** utilizado no seguinte comando não está disponível ou funcional para objetos de utilizador Exchange Online.

- Caixa de correio para desativação
- Remover caixa de correio
- Desativador de correio
- Remover carteiro