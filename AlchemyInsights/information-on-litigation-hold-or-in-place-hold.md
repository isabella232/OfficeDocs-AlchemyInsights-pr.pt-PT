...
- **Para activar uma retenção de litígios** para um único utilizador, siga os passos descritos [aqui](https://docs.microsoft.com/en-us/office365/SecurityCompliance/place-a-mailbox-on-litigation-hold). Quando a suspensão de litígios está activada, todo o conteúdo da caixa de correio é colocado em espera.
