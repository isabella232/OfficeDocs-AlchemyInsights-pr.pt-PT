...
Você pode precisar de migrar caixas de correio entre dois inquilinos diferentes, por exemplo, quando há fusões de organização. Estas migrações devem ser cuidadosamente planeadas. Consulte as seguintes orientações:
