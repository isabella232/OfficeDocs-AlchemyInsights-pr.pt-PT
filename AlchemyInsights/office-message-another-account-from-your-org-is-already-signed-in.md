...
Para mais informações, consulte [Lamentamos, já existe outra conta da sua organização com sessão iniciada neste computador](https://docs.microsoft.com/office/troubleshoot/error-messages/another-account-already-signed-in) no Office.
