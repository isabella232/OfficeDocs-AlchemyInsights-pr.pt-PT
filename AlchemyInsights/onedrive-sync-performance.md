...
---
# <a name="onedrive-sync-performance"></a>Performance de Sincronização OneDrive

Se estiver a experimentar uma sincronização mais lenta do que o esperado, ou problemas de desempenho semelhantes com o OneDrive, verifique os seguintes links:
