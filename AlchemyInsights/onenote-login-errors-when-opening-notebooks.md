...
Se receber erros de login ou palavra-passe ao tentar abrir o seu caderno, experimente o seguinte:

- Se o portátil que não abre for armazenado no OneDrive ou no SharePoint Online, tente abrir o portátil no OneNote para a web (a www.onenote.com). Se o caderno não estiver listado, poderá não ter permissões. Se for um caderno partilhado, peça ao proprietário para o partilhar e certifique-se de que está a utilizar a conta correta para fazer login.

- Se o caderno abrir no OneNote para a web, certifique-se de que está a iniciar sessão com as credenciais atuais no OneNote. 
