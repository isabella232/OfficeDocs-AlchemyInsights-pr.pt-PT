...
Antes de importar contactos para Outlook.com, terá de exportá-los a partir de outro fornecedor de correio electrónico como um ficheiro. csv. Em seguida, siga as instruções abaixo.
...
.
2. Na parte superior da página, seleccione **Gerir** \> **Importar contactos**.
3. Seleccione **Procurar**, navegue para a pasta onde guardou os contactos exportados e clique em **Abrir**.

Para obter mais informações, consulte [Importar contactos para Outlook.com](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy).