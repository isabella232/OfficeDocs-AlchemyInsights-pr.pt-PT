...
Antes de importar contactos para Outlook.com, terá de os exportar do seu outro fornecedor de e-mail como ficheiro .csv. Em seguida, siga as instruções abaixo.
...
.
2. No topo da página, selecione **'Gerir** \> **contactos'.**
3. **Selecione Navegar,** navegar para a pasta onde guardou os contactos exportados e selecione **Open**.
