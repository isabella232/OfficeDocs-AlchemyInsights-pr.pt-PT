...
---
# <a name="permanently-delete-email-in-outlookcom"></a>Eliminar permanentemente o e-mail em Outlook.com

Se quiser apagar o e-mail ou esvaziar a sua caixa de entrada:
...
1. Na parte superior da página, selecione **Eliminar** (para toda a **pasta Empty**, ou **Empty Focused**  /  **Empty Other** se tiver a caixa de entrada focada ativada).
1. Para limpar todo o seu e-mail apagado, abra a [pasta de Itens Apagados](https://outlook.live.com/mail/deleteditems) e selecione **pasta Vazia,** em seguida, selecione **itens recuperáveis** no topo da página e selecione **novamente a pasta Empty.**

Para saber mais, leia [Apagar o email em Outlook.com](https://support.office.com/article/a9b63739-5392-412a-8e9a-d4b02708dee4?wt.mc_id=Office_Outlook_com_Alchemy).