...
**Definições de** > **Ver todas as definições do Outlook** > **série** > **respostas automáticas** para abrir as [definições de respostas automáticas](https://outlook.live.com/mail/options/mail/automaticReplies).
