...
Antes de importar contactos para o Outlook na Web, terá de exportá-los do seu outro fornecedor de e-mail como um .csv ficheiro. Em seguida, siga as instruções abaixo.
 ...
 **Pessoas.**
2. Na barra de ferramentas, **selecione Gerir**  >  **Importar contactos**.
3. **Selecione Procurar ,** selecione o seu ficheiro CSV e, em seguida, selecione **Abrir**.
4. **Selecione Importar**.

Para saber mais, consulte [Importar contactos para o Outlook](https://support.office.com/article/bb796340-b58a-46c1-90c7-b549b8f3c5f8#ID0EAACAAA=Outlook_on_the_web).
