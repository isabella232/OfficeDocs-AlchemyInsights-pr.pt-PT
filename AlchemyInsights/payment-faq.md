...
Gerir os pagamentos no **centro de administração Microsoft 365**.

- Vá a **Billing > [Os seus produtos](https://go.microsoft.com/fwlink/p/?linkid=842054)** para atribuir ou alterar métodos de pagamento por subscrição.
- Vá a **Billing > [Métodos de pagamento](https://go.microsoft.com/fwlink/p/?linkid=2018806)** para adicionar, atualizar, substituir ou eliminar métodos de pagamento.
...
Para obter um guia completo sobre o pagamento da sua subscrição, consulte [Como pagar a sua subscrição.](https://docs.microsoft.com/microsoft-365/commerce/billing-and-payments/pay-for-your-subscription)
