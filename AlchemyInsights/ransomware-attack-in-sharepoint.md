...
2. Se está a procurar como proteger os seus dados do ransomware, consulte:
    - [Salvaguardando os seus dados no SharePoint e no OneDrive](https://docs.microsoft.com/sharepoint/safeguarding-your-data) 
...
3.  Todos os ficheiros do seu OneDrive ou SharePoint são afetados por Ransomware ou Malware ou vírus Crypto? 

Parar/fazer imediatamente a pausa no OneDrive Sync (se houver) ou desligar a vista do Explorer mapeada para a biblioteca a partir do computador afetado (se houver), podendo restaurar toda a sua biblioteca OneDrive ou SharePoint para uma altura anterior utilizando a funcionalidade de restauro de ficheiros. 
...
Para obter mais informações sobre a Proteção Avançada de Ameaças (ATP), consulte:
