...
---
# <a name="reactivate-a-microsoft-365-subscription"></a>Reativar uma subscrição da Microsoft 365
...
2. Escolha a subscrição que pretende reativar. Na secção de Faturação, **selecione Reativar**.

    Se não vir a **Reativação** como uma ação disponível, [ligue para o suporte](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products) para reativar a sua subscrição.
