...
---
# <a name="restrict-default-video-upload-permissions"></a>Restringir as permissões de upload de vídeo padrão
...
- [Detete as permissões de upload de vídeo padrão](https://docs.microsoft.com/stream/default-video-permissions)
