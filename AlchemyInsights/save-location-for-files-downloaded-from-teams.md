...
ms.locfileid: "43955833"
---
# <a name="save-location-for-files-downloaded-from-teams"></a>Localização para guardar ficheiros transferidos do Teams

Atualmente, os ficheiros transferidos do Teams só podem ser guardados na pasta de Transferências do perfil do utilizador (por exemplo, C:\Utilizadores\<nomedoutilizador>\Transferências).
