...
Se os utilizadores tiverem 403 um erro com o SharePoint ou OneDrive, pode verificar o [Estado de funcionamento do serviço](https://admin.microsoft.com/AdminPortal/Home#/servicehealth) para determinar se é um problema conhecido com uma resolução em curso antes de contactar o suporte ou despender tempo de resolução de problemas. O problema pode ser muito temporários e já identificados pela Microsoft, no entanto, poderá existir um lapso de tempo entre a identificação de emissão e contabilístico para o Dashboard de estado de funcionamento do serviço. Continue a verificar o dashboard do serviço de novas actualizações.
