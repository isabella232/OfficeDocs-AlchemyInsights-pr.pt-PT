...
Para mais informações sobre partilha externa (hóspedes) visite os links abaixo.
...
- [Gerir o acesso dos hóspedes em Grupos Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/create-groups/manage-guest-access-in-groups)
...
**Receber um erro com um utilizador externo (convidado)?**

Confira os links abaixo. 

- [Erros de partilha de OSE no Sharepoint ou no OneDrive](https://docs.microsoft.com/sharepoint/sharepoint-onedrive-error-message)
