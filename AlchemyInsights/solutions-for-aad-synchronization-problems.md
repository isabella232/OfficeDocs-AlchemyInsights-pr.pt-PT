...
---
# <a name="solutions-for-aad-synchronization-problems"></a>Soluções para problemas de sincronização do AAD

**Alerta no centro de administração ou e-mails automáticos a informar que não ocorreu nenhum evento de sincronização recentemente**:
...
- [Implementar a sincronização de hashes de palavras-passe com a sincronização do Azure AD Connect](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-password-hash-synchronization)
