...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d4ee3-102">Acessar a página domínios</span><span class="sxs-lookup"><span data-stu-id="d4ee3-102">Access the Domains Page</span></span>

<span data-ttu-id="d4ee3-103">Para acessar a página de domínios, basta clicar neste ícone abaixo:</span><span class="sxs-lookup"><span data-stu-id="d4ee3-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d4ee3-104">Em seguida, você pode adicionar, modificar ou remover seu domínio.</span><span class="sxs-lookup"><span data-stu-id="d4ee3-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d4ee3-105">Para obter mais informações, consulte a [FAQ de domínios.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d4ee3-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
