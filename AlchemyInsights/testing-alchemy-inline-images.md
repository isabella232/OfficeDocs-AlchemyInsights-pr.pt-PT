---
title: Testar imagens inline da Alquimia
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505066"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="3f293-102">Aceda à página de domínios</span><span class="sxs-lookup"><span data-stu-id="3f293-102">Access the Domains Page</span></span>

<span data-ttu-id="3f293-103">Para aceder à página de domínios, basta clicar neste ícone abaixo:</span><span class="sxs-lookup"><span data-stu-id="3f293-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="3f293-104">Em seguida, pode adicionar, modificar ou remover o seu domínio.</span><span class="sxs-lookup"><span data-stu-id="3f293-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="3f293-105">Para mais informações, consulte as [FAQ de Domínios.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="3f293-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
