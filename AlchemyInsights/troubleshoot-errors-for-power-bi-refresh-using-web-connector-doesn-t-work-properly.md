---
title: A atualização através do conector Web não funciona corretamente
ms.author: pebaum
author: pebaum
manager: scotv
ms.audience: Admin
...
Se tiver um script de conector Web que está a utilizar a função [Web.Page](https://msdn.microsoft.com/library/mt260924.aspx) e tiver atualizado o seu conjunto de dados ou relatório após 18 de novembro de 2016, tem de utilizar um gateway para que a atualização funcione corretamente.
