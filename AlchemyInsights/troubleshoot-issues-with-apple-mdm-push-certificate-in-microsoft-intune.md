...
ms.locfileid: "28306294"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Resolver problemas relacionados com certificados Apple Push MDM no Microsoft Intune

Reveja os recursos listados abaixo para resolver o problema agora. 
  
1. Reveja [Este documento](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) para configurar ou renovar o certificado de emissão de Apple MDM. 
