...
3. [Obter informações sobre como inscrever-se dispositivos macOS Microsoft Intune](https://docs.microsoft.com/intune/macos-enroll).
    
[Dar saída de guia de utilizador final inscrever macOS dispositivo Microsoft Intune](https://docs.microsoft.com/intune-user-help/enroll-your-device-in-intune-macos-cp)
