...
Existem várias áreas para verificar para garantir que os eventos ao vivo do Microsoft Stream funcionam sem problemas. Para mais informações, consulte [eventos ao vivo no Microsoft Stream](https://docs.microsoft.com/stream/live-event-troubleshooting).
