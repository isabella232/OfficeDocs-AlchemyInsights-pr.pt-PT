...
---
# <a name="update-dns-records-at-cloudflare"></a>Atualizar registos DNS na Cloudflare

Utilize os links abaixo para ajudar a atualizar os registos DNS.

- [Criar registos DNS na Cloudflare](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-cloudflare?view=o365-worldwide)
