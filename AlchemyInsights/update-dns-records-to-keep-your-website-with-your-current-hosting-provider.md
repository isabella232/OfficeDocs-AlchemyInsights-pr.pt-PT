...
Como parte do processo de mover seu site público do Office 365 para outro provedor de hospedagem, você provavelmente precisará fazer alterações em seus registros de domínio.
  
1. No centro de administração, vá para **** \> **domínios** de configuração e escolha o nome de domínio que você deseja alterar.

2. Insira as informações que se alinha ao seu site com seu novo provedor de hospedagem.

Para saber mais, consulte [atualizar registros DNS para manter seu site com seu provedor de hospedagem atual](https://docs.microsoft.com/office365/admin/dns/update-dns-records-to-retain-current-hosting-provider).
