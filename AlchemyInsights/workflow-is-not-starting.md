...
- Fluxos de trabalho do SharePoint 2010 atrasada no início.
    ...
    Se o fluxo de trabalho complexos Extensible objecto Markup Language (XMOL), compilação pode ser lenta. Consulte [Este](https://support.microsoft.com/en-us/kb/3043697) artigo.
    ...
    Além disso, se tiver aumentado o histórico de fluxo de trabalho, poderá pretender remover os itens ou criar uma nova lista do histórico.
...
Pretende tentar fluxo reabertos no SharePoint Online?
